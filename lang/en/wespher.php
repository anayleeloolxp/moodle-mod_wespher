...
$string['modulename'] = 'Leeloo LXP videoconference';
$string['modulenameplural'] = 'Leeloo LXP videoconferences';
$string['wesphername_help'] = 'Use the Leeloo LXP module for videoconference ';
$string['wespher:addinstance'] = 'Add a new Leeloo LXP videoconference';
$string['wespher:submit'] = 'Submit Leeloo LXP videoconference';
$string['wespher:view'] = 'View Leeloo LXP videoconference';
$string['wesphername'] = 'Session name';
$string['wespher'] = 'Leeloo LXP';
$string['pluginadministration'] = 'Leeloo LXP administration';
$string['pluginname'] = 'Leeloo LXP videoconference';
$string['joininfo'] = 'Click the button to join videoconference';
$string['join'] = 'Join';
$string['wespherstart'] = 'The Leeloo LXP videoconference \'{$a}\' start';
...
$string['beforetime'] = 'Allow joining mintues before';
$string['completed'] = 'Video Conference status';
$string['recordedurl'] = 'If completed URL of recording';
